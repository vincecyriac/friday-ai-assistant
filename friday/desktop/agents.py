...
Tiers (models come from FRIDAY_LLM_AGENT_OS / FRIDAY_LLM_AGENT_SPATIAL,
default gemini-3.8-flash for both)
  os       macOS automation, AppleScript, shell, multi-step GUI control and
           system logic.
  spatial  fast structured JSON: 3D scene deltas for the SVE,
           screen-coordinate denormalisation.
